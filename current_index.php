...
<head>
    ...
    <style>
        ...
        #danger-meter { width: 60%; min-height: 60px; height: auto; padding: 10px; box-sizing: border-box; border: 2px solid var(--muted-text); border-radius: 5px; margin-bottom: 15px; display: flex; align-items: center; justify-content: center; font-size: 1.2em; font-weight: 700; text-transform: uppercase; }
        ...
        #permit-modal-content { background-color: var(--card-bg); padding: 15px; border-radius: 8px; border: 1px solid var(--muted-text); width: 100%; max-width: 900px; color: var(--text-color); font-size: 1.0em; cursor: pointer; display: flex; flex-direction: column; }
        #permit-modal-header h2 { margin-top: 0; margin-bottom: 5px; font-size: 1.0em; color: #ffc107;  white-space: nowrap; }
