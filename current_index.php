...
<head>
    ...
    <style>
        ...
        #permit-modal-content { background-color: var(--card-bg); padding: clamp(6px, 1.5vh, 15px); border-radius: 8px; border: 1px solid var(--muted-text); width: 100%; max-width: 900px; color: var(--text-color); font-size: 1.0em; cursor: pointer; display: flex; flex-direction: column; }
        #permit-modal-header h2 { margin-top: 0; margin-bottom: clamp(1px, 0.5vh, 5px); font-size: 1.0em; color: #ffc107;  white-space: nowrap; }
    ...
    <script>
        ...
        function manageFireDangerPolling(lastUpdateStr) {
            ...
            window.fireDangerInterval = setInterval(loadFireDanger, pollInterval);
                ...
                function isOutdatedDate(dateStr) {
        ...
        async function loadFireDanger() {
            ...
            if (riskLevel !== "Unknown" && lastUpdateStr !== "") {
                if (isOutdatedDate(lastUpdateStr)) {
                    riskLevel = "Unknown";
                }
            }
